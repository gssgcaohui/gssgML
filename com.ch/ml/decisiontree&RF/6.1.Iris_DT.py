...
if __name__ == "__main__":
    path = '../regression/data/4.iris.data'  # 数据文件路径
    ...
    clf = DecisionTreeClassifier(criterion='entropy', min_samples_leaf=3, max_depth=5) #
    dt_clf = clf.fit(x, y)
    ...
    plt.scatter(x[:, 0], x[:, 1], c=y, edgecolors='k', cmap=plt.cm.prism ,s =60)  # 样本的显示  s这里是点的面积
